...
-targetargs:"/testcontainer:\"%~dp0UnitTest\BusinessAccess\GE.DigitalCockpit.BusinessAccess.Common.Test\bin\Debug\GE.DigitalCockpit.BusinessAccess.Common.Test.dll\" /testcontainer:\"%~dp0GE.DigitalCockpit.BusinessAccess.FLDC.Test\bin\Debug\GE.DigitalCockpit.BusinessAccess.FLDC.Test.dll\" /testcontainer:\"%~dp0UnitTest\DataAccess\GE.DigitalCockpit.DataAccess.FLDC\bin\Debug\GE.DigitalCockpit.DataAccess.FLDC.Test.dll\" /testcontainer:\"%~dp0GE.DigitalCockpit.BusinessAccess.LLDC.Test\bin\Debug\GE.DigitalCockpit.BusinessAccess.LLDC.Test.dll\" /testcontainer:\"%~dp0GE.DigitalCockpit.DataAccess.LLDC.Test\bin\Debug\GE.DigitalCockpit.DataAccess.LLDC.Test.dll\" /resultsfile:\"%~dp0GeneratedReports\GEDigitalCockpitTest.trx\"" ^
